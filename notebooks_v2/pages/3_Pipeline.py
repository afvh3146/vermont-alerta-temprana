...
with tab1:
    ...
    <div style="display:flex;align-items:stretch;gap:0;justify-content:center;flex-wrap:wrap">
        ...
        <!-- Fuente -->
        <div style="background:#fff;border:2px solid #bdc3c7;border-radius:10px;
                    padding:16px;min-width:140px;text-align:center">
            <div style="font-size:1.6em">🏫</div>
            <div style="font-weight:700;margin-top:6px">Phidias</div>
            <div style="font-size:0.78em;color:#666;margin-top:4px">
                Exportación XLS<br>manual
            </div>
        </div>

        <div style="display:flex;align-items:center;padding:0 8px;
                    font-size:1.4em;color:#95a5a6">→</div>

        <!-- Bronze -->
        <div style="background:#fef9e7;border:2px solid #f39c12;border-radius:10px;
                    padding:16px;min-width:140px;text-align:center">
            <div style="font-size:1.6em">🥉</div>
            <div style="font-weight:700;color:#e67e22;margin-top:6px">Bronze</div>
            <div style="font-size:0.78em;color:#666;margin-top:4px">
                XLS raw<br>CSV anonimizado<br>Parquet preparado
            </div>
        </div>
        ...
        <!-- Trusted -->
        <div style="background:#eaf4fb;border:2px solid #3498db;border-radius:10px;
                    padding:16px;min-width:140px;text-align:center">
            <div style="font-size:1.6em">🥈</div>
            <div style="font-weight:700;color:#2980b9;margin-top:6px">Trusted</div>
            <div style="font-size:0.78em;color:#666;margin-top:4px">
                Dataset train<br>Dataset predicción<br>Parquet
            </div>
        </div>
        ...
        <!-- Silver -->
        <div style="background:#eafaf1;border:2px solid #2ecc71;border-radius:10px;
                    padding:16px;min-width:140px;text-align:center">
            <div style="font-size:1.6em">🥇</div>
            <div style="font-weight:700;color:#27ae60;margin-top:6px">Silver</div>
            <div style="font-size:0.78em;color:#666;margin-top:4px">
                EDA · Modelo<br>Alertas · CSV<br>dashboard
            </div>
        </div>
        ...
        <!-- Dashboard -->
        <div style="background:#fdf2f8;border:2px solid #9b59b6;border-radius:10px;
                    padding:16px;min-width:140px;text-align:center">
            <div style="font-size:1.6em">📊</div>
            <div style="font-weight:700;color:#8e44ad;margin-top:6px">Dashboard</div>
            <div style="font-size:0.78em;color:#666;margin-top:4px">
                Streamlit<br>Vermont EWS<br>vmt-ews-acad
            </div>
        </div>
...
with tab3:
    ...
    grupos = {
        ...
        "🤖 Salidas del modelo de clasificación": [
            ...
            ("categoria",       "Categoría de alerta: Sin Riesgo / Riesgo Teórico / Riesgo Confirmado / Punto Ciego", "Derivada · lógica de cuadrante"),

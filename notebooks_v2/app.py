...
with tab4:
    ...
    # Fila de RF con umbral optimizado
    ...
    df_imp_clf = pd.DataFrame(imp_clf_data,
                               columns=["Variable", "Importancia", "Descripción"])
    ...
    df_imp_reg = pd.DataFrame(imp_reg_data,
                               columns=["Variable", "Importancia", "Descripción"])
